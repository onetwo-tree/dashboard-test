...
const Notification = () => {
  ...
  return (
    <div className="nav-item absolute right-5 md:right-39 top-16 bg-white dark:bg-[#42464D] p-8 rounded-lg w-96">
      <div className="flex justify-between items-center">
        ...
        {/* Justify-between right side */}
        <Button icon={<MdOutlineCancel />} color="white" bgHoverColor="light-gray" size="2xl" borderRadius="50%" />
      </div>
